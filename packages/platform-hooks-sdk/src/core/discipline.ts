 ...
 * frame + progress segment; the value-ratio benefit graphic is rendered
 * by the context module's own ledger path — family junction eliminated
 * (ADR 0192), the base echo renders without benefit facts); this module
 * owns the INJECTION mechanics: canonical-line dedup, self-healing
 * strip of non-canonical `[seam]` lines, and append-to-last-user-message.
 *
